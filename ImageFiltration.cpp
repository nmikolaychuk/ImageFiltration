...
// ImageFiltration.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CImageFiltrationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CImageFiltrationApp

CImageFiltrationApp::CImageFiltrationApp()
{
...
// Единственный объект CImageFiltrationApp

CImageFiltrationApp theApp;


// Инициализация CImageFiltrationApp

BOOL CImageFiltrationApp::InitInstance()
{
